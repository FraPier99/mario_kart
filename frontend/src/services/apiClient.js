...
export const inventoryApi = {
    ...
    tournamentPendingEffects: (tournamentId) => _get(`/inventory/tournament/${tournamentId}/pending-effects`),
    resolveCardUsage: (logId, raceId) => _post(`/inventory/card-usage/${logId}/resolve`, { race_id: raceId }),
