...
export const TOURNAMENT_STATUS_META = {
    ...
    finito: { label: 'Gare finite', Icon: CheckCircle2, className: 'border-blue-200 dark:border-blue-500/30 bg-blue-50 dark:bg-blue-500/10 text-blue-700 dark:text-blue-300' },
