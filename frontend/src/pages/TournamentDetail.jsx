                        ...
                        <div className="rounded-2xl border-2 border-slate-200 dark:border-border bg-white dark:bg-card p-5">
                            <div className="flex flex-wrap items-center justify-between gap-4">
                                ...
                                <button type="button" onClick={() => setActiveSection('races')}
                                    className="font-title w-full sm:w-auto sm:shrink-0 rounded-xl border-2 border-blue-300 dark:border-blue-500/30 bg-blue-50 dark:bg-blue-500/10 px-4 py-2.5 text-center text-[10px] tracking-wide text-blue-700 dark:text-blue-300 transition active:translate-y-px hover:bg-blue-100 dark:hover:bg-blue-500/20">
