...
import { Map as MapIcon, Trophy, Medal, BarChart3, TrendingUp, Swords, ChevronDown } from 'lucide-react'
...
const CircuitStats = () => {
    ...
    useEffect(() => {
        ...
        statsApi.circuitList(effectiveGameId)
            .then((res) => setCircuitStats(res.data.filter((c) => c.total_races > 0)))
            ...
            <section className="mx-auto max-w-7xl px-4 py-8 animate-fade-in">
                ...
                <div className="grid gap-6">
                    {circuitStats.map((circuit, i) => {
                        ...
                        return (
                            <div key={circuit.circuit_id} style={{ animationDelay: `${i * 0.05}s` }} className="animate-slide-up overflow-hidden rounded-3xl border border-slate-200 dark:border-border bg-white dark:bg-card shadow-lg shadow-slate-200/60 dark:shadow-black/20 hover-lift">
