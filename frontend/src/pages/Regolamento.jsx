        ...
        <AppLayout>
            <section className="mx-auto max-w-7xl px-4 py-8 animate-fade-in">
                ...
                <div className="mb-6 flex flex-wrap items-end justify-between gap-4">
                    <div>
                        <p className={`font-title text-[10px] tracking-wide ${theme.tailwind.text}`}>REGOLAMENTO</p>
                ...
                <div
                    className="rounded-[2rem] border-2 border-slate-900 dark:border-white/20 bg-white p-6 dark:bg-card"
                    style={{ boxShadow: 'var(--circuit-shadow-lg)' }}
                >
                    <div className="flex flex-wrap items-start justify-between gap-3">
                        <div>
                            <p className={`font-title text-[10px] tracking-wide ${theme.tailwind.text}`}>Formato torneo</p>
                            <h2 className="mt-2 font-title text-2xl uppercase tracking-tight text-slate-900 dark:text-foreground">Struttura e regole</h2>
                        </div>
                        <div className="inline-flex rounded-xl border-2 border-slate-300 dark:border-border bg-slate-100 dark:bg-muted p-0.5">
                            <button type="button" onClick={() => setFormatSubTab('unica')} className={`font-title rounded-lg px-3 py-2 text-[9px] tracking-wide transition ${formatSubTab === 'unica' ? 'bg-white text-slate-900 shadow-sm dark:bg-card dark:text-foreground' : 'text-slate-500 dark:text-muted-foreground hover:text-slate-700'}`}>
                                Classifica Unica
                            </button>
                            <button type="button" onClick={() => setFormatSubTab('gironi')} className={`font-title rounded-lg px-3 py-2 text-[9px] tracking-wide transition ${formatSubTab === 'gironi' ? 'bg-white text-slate-900 shadow-sm dark:bg-card dark:text-foreground' : 'text-slate-500 dark:text-muted-foreground hover:text-slate-700'}`}>
                                Gironi
                            </button>
                        </div>
                    </div>
                    ...
                    {formatSubTab === 'gironi' ? (
                        <>
                            {/* Panoramica Gironi */}
                            <div className="mt-5 rounded-2xl border-2 border-sky-300 dark:border-sky-500/30 bg-sky-50/50 dark:bg-sky-500/5 p-4">
                                <div className="flex items-center gap-2 text-sky-700 dark:text-sky-300">
                                    <Users size={18} />
                                    <p className="font-title text-[11px] tracking-wide">Panoramica</p>
                                </div>
                        ...
                        <>
                            ...
                            <div className="mt-5 rounded-2xl border-2 border-emerald-300 dark:border-emerald-500/30 bg-emerald-50/50 dark:bg-emerald-500/5 p-4">
                    ...
                    <div className="mt-5 rounded-2xl border-2 border-slate-300 dark:border-white/15 bg-slate-50 p-4 dark:bg-muted">
                        <div className="flex items-center gap-2 text-slate-900 dark:text-foreground">
                            <FileText size={16} className={theme.tailwind.text} />
                            <p className="font-title text-[11px] tracking-wide">Regole pratiche</p>
                        </div>
                        {formatSubTab === 'gironi' ? (
